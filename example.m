...
load('/home/pig/Face/FaceRecognition/SRC/srv1_9/data/smallRoundBlueCellTumorOFChildhood.mat','Data','classes');
D=Data;
clear('Data');
kfold=3;
...
dirData='/home/pig/Face/FaceRecognition/SRC/srv1_9/data/face95.mat';
...
% suppose the current folder is the one containing the SR Toolbox
load('/home/pig/Face/FaceRecognition/SRC/srv1_9/data/breastTissue.mat','D','classes');
D=D';
...
load('/home/pig/Face/FaceRecognition/SRC/srv1_9/data/InfBetaTensorComplete.mat','D','classes');
kfold=9;
ind=crossvalind('Kfold',classes,kfold);
indTest=(ind==1);
trainSet=D(:,:,~indTest);
